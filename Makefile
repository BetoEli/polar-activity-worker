...
FAST_TESTS=FullyQualifiedName~SyncServiceTests|FullyQualifiedName~ActivitySyncServiceTests|FullyQualifiedName~WebhookFlowEndToEndTests|FullyQualifiedName~SyncEndpointsTests|FullyQualifiedName~QepPolarEndpointsTests|FullyQualifiedName~QepMapperIntegrationTests|FullyQualifiedName~PolarLinksIntegrationTests|FullyQualifiedName~PolarClientRetryTests|FullyQualifiedName~PolarWebhookVerifierTests|FullyQualifiedName~QepApiKeyAuthFilterTests|FullyQualifiedName~PolarWorkoutMapperTests|FullyQualifiedName~PolarToQepMapperTests|FullyQualifiedName~SyncHistoryEndpointTests
